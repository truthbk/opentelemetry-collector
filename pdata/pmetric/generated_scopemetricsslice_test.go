...
func TestScopeMetricsSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestScopeMetrics()
...
func TestScopeMetricsSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestScopeMetricsSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestScopeMetricsSlice().getOrig(), *dest.getOrig())
}
...
func TestScopeMetricsSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestScopeMetricsSlice().getOrig(), *es.getOrig())
...
func generateTestScopeMetricsSlice() ScopeMetricsSlice {
	...
	*ms.getOrig() = internal.GenTestScopeMetricsPtrSlice()
	return ms
}
