...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	internal.DeleteExportMetricsPartialSuccess(dest.getOrig(), false)
...
func (ms ExportPartialSuccess) CopyTo(dest ExportPartialSuccess) {
	dest.getState().AssertMutable()
	internal.CopyExportMetricsPartialSuccess(dest.getOrig(), ms.getOrig())
}

func (ms ExportPartialSuccess) getOrig() *internal.ExportMetricsPartialSuccess {
	return ms.orig
}
