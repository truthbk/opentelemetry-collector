...
func TestResourceMetricsSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestResourceMetrics()
...
func TestResourceMetricsSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestResourceMetricsSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestResourceMetricsSlice().getOrig(), *dest.getOrig())
}
...
func TestResourceMetricsSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestResourceMetricsSlice().getOrig(), *es.getOrig())
...
func generateTestResourceMetricsSlice() ResourceMetricsSlice {
	...
	*ms.getOrig() = internal.GenTestResourceMetricsPtrSlice()
	return ms
}
