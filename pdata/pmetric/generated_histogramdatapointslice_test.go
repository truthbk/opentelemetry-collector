...
func TestHistogramDataPointSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestHistogramDataPoint()
...
func TestHistogramDataPointSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestHistogramDataPointSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestHistogramDataPointSlice().getOrig(), *dest.getOrig())
}
...
func TestHistogramDataPointSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestHistogramDataPointSlice().getOrig(), *es.getOrig())
...
func generateTestHistogramDataPointSlice() HistogramDataPointSlice {
	...
	*ms.getOrig() = internal.GenTestHistogramDataPointPtrSlice()
	return ms
}
