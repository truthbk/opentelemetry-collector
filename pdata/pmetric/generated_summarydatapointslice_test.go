...
func TestSummaryDataPointSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestSummaryDataPoint()
...
func TestSummaryDataPointSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestSummaryDataPointSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestSummaryDataPointSlice().getOrig(), *dest.getOrig())
}
...
func TestSummaryDataPointSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestSummaryDataPointSlice().getOrig(), *es.getOrig())
...
func generateTestSummaryDataPointSlice() SummaryDataPointSlice {
	...
	*ms.getOrig() = internal.GenTestSummaryDataPointPtrSlice()
	return ms
}
