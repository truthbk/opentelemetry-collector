...
func TestExponentialHistogramDataPointSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestExponentialHistogramDataPoint()
...
func TestExponentialHistogramDataPointSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestExponentialHistogramDataPointSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestExponentialHistogramDataPointSlice().getOrig(), *dest.getOrig())
}
...
func TestExponentialHistogramDataPointSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestExponentialHistogramDataPointSlice().getOrig(), *es.getOrig())
...
func generateTestExponentialHistogramDataPointSlice() ExponentialHistogramDataPointSlice {
	...
	*ms.getOrig() = internal.GenTestExponentialHistogramDataPointPtrSlice()
	return ms
}
