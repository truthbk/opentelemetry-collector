...
func (es HistogramDataPointSlice) EnsureCapacity(newCap int) {
	...
	newOrig := make([]*internal.HistogramDataPoint, len(*es.getOrig()), newCap)
...
func (es HistogramDataPointSlice) AppendEmpty() HistogramDataPoint {
	es.getState().AssertMutable()
	*es.getOrig() = append(*es.getOrig(), internal.NewHistogramDataPoint())
...
func (es HistogramDataPointSlice) RemoveIf(f func(HistogramDataPoint) bool) {
	...
	for i := 0; i < len(*es.getOrig()); i++ {
		if f(es.At(i)) {
			internal.DeleteHistogramDataPoint((*es.getOrig())[i], true)
			(*es.getOrig())[i] = nil
...
func (es HistogramDataPointSlice) CopyTo(dest HistogramDataPointSlice) {
	...
	*dest.getOrig() = internal.CopyHistogramDataPointPtrSlice(*dest.getOrig(), *es.getOrig())
}
...
func (ms HistogramDataPointSlice) getOrig() *[]*internal.HistogramDataPoint {
	return ms.orig
}
