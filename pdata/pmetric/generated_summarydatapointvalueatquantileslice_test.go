...
func TestSummaryDataPointValueAtQuantileSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestSummaryDataPointValueAtQuantile()
...
func TestSummaryDataPointValueAtQuantileSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestSummaryDataPointValueAtQuantileSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestSummaryDataPointValueAtQuantileSlice().getOrig(), *dest.getOrig())
}
...
func TestSummaryDataPointValueAtQuantileSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestSummaryDataPointValueAtQuantileSlice().getOrig(), *es.getOrig())
...
func generateTestSummaryDataPointValueAtQuantileSlice() SummaryDataPointValueAtQuantileSlice {
	...
	*ms.getOrig() = internal.GenTestSummaryDataPointValueAtQuantilePtrSlice()
	return ms
}
