...
func TestResourceProfilesSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestResourceProfiles()
...
func TestResourceProfilesSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestResourceProfilesSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestResourceProfilesSlice().getOrig(), *dest.getOrig())
}
...
func TestResourceProfilesSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestResourceProfilesSlice().getOrig(), *es.getOrig())
...
func generateTestResourceProfilesSlice() ResourceProfilesSlice {
	...
	*ms.getOrig() = internal.GenTestResourceProfilesPtrSlice()
	return ms
}
