...
func TestValueTypeSlice(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		...
		(*es.getOrig())[i] = internal.GenTestValueType()
...
func TestValueTypeSlice_CopyTo(t *testing.T) {
	...
	src.CopyTo(dest)
	assert.Equal(t, *generateTestValueTypeSlice().getOrig(), *dest.getOrig())
	dest.CopyTo(dest)
	assert.Equal(t, *generateTestValueTypeSlice().getOrig(), *dest.getOrig())
}
...
func TestValueTypeSlice_EnsureCapacity(t *testing.T) {
	...
	assert.Equal(t, *generateTestValueTypeSlice().getOrig(), *es.getOrig())
...
func generateTestValueTypeSlice() ValueTypeSlice {
	...
	*ms.getOrig() = internal.GenTestValueTypePtrSlice()
	return ms
}
