...
func (ms ExportResponse) MoveTo(dest ExportResponse) {
	...
	internal.DeleteExportTraceServiceResponse(dest.getOrig(), false)
...
func (ms ExportResponse) CopyTo(dest ExportResponse) {
	dest.getState().AssertMutable()
	internal.CopyExportTraceServiceResponse(dest.getOrig(), ms.getOrig())
}

func (ms ExportResponse) getOrig() *internal.ExportTraceServiceResponse {
	return ms.orig
}
